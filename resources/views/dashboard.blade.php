    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 -mt-4">
        <div class="grid gap-5 sm:grid-cols-1 lg:grid-cols-2">
            ...
            <div class="store-card p-5 lg:p-6">
                <div class="flex items-start gap-5">
                    <div class="flex-shrink-0 w-10 h-10 rounded-store-lg bg-calm-surface flex items-center justify-center dashboard-icon-box">
                        <svg class="w-5 h-5 text-calm-muted dashboard-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
